...
public class Checkout extends HBox {
    ...
    //Handler for chosen payment, makes confirm button visible
    ...
    private EventHandler<ActionEvent> confirmHandler = new EventHandler<ActionEvent>() {
        ...
        public void handle(ActionEvent actionEvent) {
            ...
            if (chosenPayment == null || chosenShipping == null || fNameText.getText().isEmpty()
                    || lNameText.getText().isEmpty() || streetNameText.getText().isEmpty() ||
                    houseNumberText.getText().isEmpty() || zip.getText().isEmpty() || city.getText().isEmpty()
            ...
            basket.submitOrder(false, payment, shipping);
            basket.clear();
