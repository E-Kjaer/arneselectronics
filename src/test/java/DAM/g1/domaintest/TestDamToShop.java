...
public class TestDamToShop {
    ...
    public void init(){
        ...
        this.damToShop = new DamToShop(accessDatabase);
    ...
    public void testGetImagesByTagsSingleTag(){
        String output = damToShop.getImagesByTags("{\"tags\":[\"Grey\"]}");
    ...
    public void testGetImagesByTagsMultipleTags(){
        String output = damToShop.getImagesByTags("{\"tags\":[\"Grey\",\"Yellow\"]}");
    ...
    public void testGetImagesByTagsInvalidInput(){
        String output = damToShop.getImagesByTags("dadawdjioawdaw{[{[]{[{{{{wdawdkado]}}]}}]}");
